...
export const workspaceApi = {
  ...
  localVoiceDefaults: () => invoke<{ program: string; model: string }>("local_voice_defaults"),
  ...
  transcribeVoice: (audio: number[], program: string, model: string, approved: boolean) => invoke<string>("transcribe_voice", { audio, program, model, approved }),
  speak: (text: string, approved: boolean) => invoke<void>("speak_text", { text, approved }),
  ...
  loadIndex: () => invoke<CodeIndex>("load_code_index"),
